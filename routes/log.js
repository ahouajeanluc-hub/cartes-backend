...
async function getLogsByPeriod(req, res) {
    try {
...
// 🧹 SUPPRIMER LES LOGS ANCIENS (MAINTENANCE)
...
router.get('/utilisateur/:utilisateur', getLogsByUser);
router.get('/periode', getLogsByPeriod);
router.delete('/nettoyer', cleanOldLogs);
